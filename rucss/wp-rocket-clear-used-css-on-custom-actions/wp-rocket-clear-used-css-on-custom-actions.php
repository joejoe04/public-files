...
// EDIT HERE:
// Change only the first parameter ('wp_insert_post' below for example) to the action you would like to trigger clearing of Used CSS. Add as many lines as needed to clear the Used CSS on multiple actions.
